...
screen = [[0 for y in xrange(32)] for x in xrange(64)]
...
def refresh():
    for row in range(64):
        ...
        for col in range(32):
            ...
            set_color_bottom(screen[row][col])
            clock()
...
fill_rectangle(0, 0, 14, 32, 4)
fill_rectangle(22, 10, 30, 15, 2)
fill_rectangle(15, 20, 19, 7, 7)
